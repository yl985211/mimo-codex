...
export class DoctorService {
  ...
  private async buildTargets(): Promise<DoctorTarget[]> {
    const targets: DoctorTarget[] = [
      ...
      this.jsonTarget(
        'mimo-codex-providers',
        'Managed providers',
        'user',
        path.join(this.configDir, 'mimo-codex', 'providers.json'),
      ),
      this.jsonTarget(
        'mimo-codex-settings',
        'Managed provider settings',
        'user',
        path.join(this.configDir, 'mimo-codex', 'settings.json'),
      ),
      ...
      this.jsonTarget('oauth', 'OAuth tokens', 'user', path.join(this.configDir, 'mimo-codex', 'oauth.json')),
      this.jsonTarget(
        'openai-oauth',
        'OpenAI OAuth tokens',
        'user',
        path.join(this.configDir, 'mimo-codex', 'openai-oauth.json'),
      ),
    ]
