...
</head><body><div class="card"><h1>OpenAI Login Successful</h1><p>You can close this window and return to MiMo-Codex.</p></div>
...
export function getHahaOpenAIOAuthFilePath(): string {
  ...
  return path.join(configDir, 'mimo-codex', 'openai-oauth.json')
}
