...
/**
 * Read env vars from ~/.claude/mimo-codex/settings.json (Haha-specific provider
...
function getCcHahaSettingsEnv(): Record<string, string> {
  try {
    const ccHahaSettings = join(getClaudeConfigHomeDir(), 'mimo-codex', 'settings.json')
...
export function applySafeConfigEnvironmentVariables(): void {
  ...
  // mimo-codex provider isolation: apply env from ~/.claude/mimo-codex/settings.json
...
export function applyConfigEnvironmentVariables(): void {
  ...
  // mimo-codex provider isolation: same as in applySafeConfigEnvironmentVariables,
