...
export const DESKTOP_PERSISTENCE_VERSION_KEY = 'mimo-codex.persistence.schemaVersion'
...
const SESSION_RUNTIME_STORAGE_KEY = 'mimo-codex-session-runtime'
const THEME_STORAGE_KEY = 'mimo-codex-theme'
const LOCALE_STORAGE_KEY = 'mimo-codex-locale'
