...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.terminal.description': '直接執行宿主機命令，用於安裝外掛、Skills、MCP 等擴充套件。桌面端已內建 mimo-codex；文件裡的 claude <引數> 可替換成 mimo-codex <引數>，例如 mimo-codex plugin install ... 或 mimo-codex mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': '只會清理：mimo-codex-open-tabs、mimo-codex-session-runtime、mimo-codex-theme、mimo-codex-locale 和 mimo-codex.persistence.schemaVersion。',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/mimo-codex/settings.json — 直接編輯，儲存時寫入。',
  ...
  'settings.general.storagePortableDirPlaceholder': '選擇一個用於儲存 mimo-codex 資料的資料夾',
  ...
  'settings.general.storageMoveHint': '切換目錄不會自動搬遷舊資料。如果希望舊會話繼續出現，請把原目錄下的 projects、skills、plugins、mimo-codex 等資料複製到新目錄。要做便攜包，建議把目錄放在應用旁邊並一起壓縮。',
  ...
  'settings.general.notificationsTestTitle': 'MiMo-Codex 通知已啟用',
  ...
  'settings.general.traceHintOn': '新會話會把精簡請求、回應、狀態事件寫入本機 mimo-codex traces 目錄。',
  ...
  // ─── Empty Session ──────────────────────────────────────
  'empty.title': '新建會話',
  'empty.subtitle': '開始一個新的編碼會話。MiMo-Codex 已準備好幫你構建、除錯和架構你的專案。',
