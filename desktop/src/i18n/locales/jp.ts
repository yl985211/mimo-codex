...
export const jp: Record<TranslationKey, string> = {
  ...
  'settings.terminal.description': 'プラグイン、スキル、MCP のセットアップ用にホストマシンのコマンドを実行します。デスクトップアプリには mimo-codex が含まれています。ドキュメントの claude <args> を mimo-codex <args> に置き換えてください。例: mimo-codex plugin install ... や mimo-codex mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': 'クリアされるのは次のみ: mimo-codex-open-tabs、mimo-codex-session-runtime、mimo-codex-theme、mimo-codex-locale、mimo-codex.persistence.schemaVersion。',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/mimo-codex/settings.json — 直接編集できます。保存時に書き込まれます。',
  ...
  'settings.general.storagePortableDirPlaceholder': 'mimo-codex データ用のフォルダを選択',
  ...
  'settings.general.storageMoveHint': 'ディレクトリを切り替えても既存のデータは移行されません。以前のセッションを引き続き表示したい場合は、古いディレクトリから projects、skills、plugins、mimo-codex および関連フォルダをコピーしてください。ポータブルバンドルにする場合は、このフォルダをアプリの隣に置いて一緒に zip 化してください。',
  ...
  'settings.general.notificationsTestTitle': 'MiMo-Codex の通知が有効になりました',
  ...
  'settings.general.traceHintOn': '新しいセッションは、簡潔な要求、応答、状態イベントをローカルの mimo-codex traces ディレクトリに書き込みます。',
  ...
  'empty.subtitle': '新しいコーディングセッションを開始します。MiMo-Codex は、プロジェクトの構築、デバッグ、設計をお手伝いする準備ができています。',
