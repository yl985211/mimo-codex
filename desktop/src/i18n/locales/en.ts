export const en = {
  ...
  'settings.activity.defaultHandle': 'github.com/yl985211/mimo-codex',
  ...
  'settings.terminal.description': 'Run host-machine commands for plugin, skill, and MCP setup. The desktop app includes mimo-codex; replace documented claude <args> with mimo-codex <args>, for example: mimo-codex plugin install ... or mimo-codex mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': 'Clears only: mimo-codex-open-tabs, mimo-codex-session-runtime, mimo-codex-theme, mimo-codex-locale, and mimo-codex.persistence.schemaVersion.',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/mimo-codex/settings.json — edit directly, will be written on save.',
  ...
  'settings.general.storagePortableDirPlaceholder': 'Choose a folder for mimo-codex data',
  ...
  'settings.general.storageMoveHint': 'Switching directories does not migrate existing data. Copy projects, skills, plugins, mimo-codex, and related folders from the old directory if you want old sessions to keep appearing. For a portable bundle, keep this folder beside the app and zip them together.',
  ...
  'settings.general.notificationsTestTitle': 'MiMo-Codex notifications are enabled',
  ...
  'settings.general.traceHintOn': 'New sessions write compact requests, responses, and status events to the local mimo-codex traces directory.',
  ...
  'empty.subtitle': 'Start a fresh coding session. MiMo-Codex is ready to help you build, debug, and architect your project.',
