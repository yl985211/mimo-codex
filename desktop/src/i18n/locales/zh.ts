...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.terminal.description': '直接运行宿主机命令，用于安装插件、Skills、MCP 等扩展。桌面端已内置 mimo-codex；文档里的 claude <参数> 可替换成 mimo-codex <参数>，例如 mimo-codex plugin install ... 或 mimo-codex mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': '只会清理：mimo-codex-open-tabs、mimo-codex-session-runtime、mimo-codex-theme、mimo-codex-locale 和 mimo-codex.persistence.schemaVersion。',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/mimo-codex/settings.json — 直接编辑，保存时写入。',
  ...
  'settings.general.storagePortableDirPlaceholder': '选择一个用于保存 mimo-codex 数据的文件夹',
  ...
  'settings.general.storageMoveHint': '切换目录不会自动搬迁旧数据。如果希望旧会话继续出现，请把原目录下的 projects、skills、plugins、mimo-codex 等数据复制到新目录。要做便携包，建议把目录放在应用旁边并一起压缩。',
  ...
  'settings.general.notificationsTestTitle': 'MiMo-Codex 通知已启用',
  ...
  'settings.general.traceHintOn': '新会话会把精简请求、响应、状态事件写入本机 mimo-codex traces 目录。',
  ...
  // ─── Empty Session ──────────────────────────────────────
  'empty.title': '新建会话',
  'empty.subtitle': '开始一个新的编码会话。MiMo-Codex 已准备好帮你构建、调试和架构你的项目。',
