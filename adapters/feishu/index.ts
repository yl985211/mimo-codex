...
// Lazy-load Lark SDK to avoid bundling in sidecar
let Lark: any = null
...
const LarkSDK = await getLark()
const larkClient = new LarkSDK.Client({
...
const { FeishuMediaService } = await import('./media.js')
