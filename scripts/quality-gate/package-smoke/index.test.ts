...
describe('packaged artifact inspection', () => {
  test('passes macOS bundle structure checks and records optional archive artifacts', async () => {
    ...
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/MiMo-Codex.app/Contents/Info.plist')
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/MiMo-Codex.app/Contents/MacOS/MiMo-Codex')
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/MiMo-Codex.app/Contents/Resources/app.asar')
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/MiMo-Codex.app/Contents/Resources/app-update.yml')
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/MiMo-Codex.app/Contents/Resources/app.asar.unpacked/dist/index.html')
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/MiMo-Codex.app/Contents/Resources/app.asar.unpacked/src-tauri/binaries/claude-sidecar-aarch64-apple-darwin')
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/MiMo-Codex.app/Contents/Resources/app.asar.unpacked/node_modules/node-pty/package.json')
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/MiMo-Codex.app/Contents/Resources/app.asar.unpacked/node_modules/node-pty/prebuilds/darwin-arm64/pty.node')
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/MiMo-Codex.app/Contents/Resources/app.asar.unpacked/node_modules/node-pty/prebuilds/darwin-arm64/spawn-helper')
  ...
  test('fails macOS archive checks when latest-mac.yml points at missing assets', async () => {
    ...
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/MiMo-Codex.app/Contents/Resources/app.asar.unpacked/node_modules/node-pty/prebuilds/darwin-arm64/pty.node')
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/MiMo-Codex.app/Contents/Resources/app.asar.unpacked/node_modules/node-pty/prebuilds/darwin-arm64/spawn-helper')
    writeFile(rootDir, 'desktop/build-artifacts/electron/MiMo-Codex-0.3.1-arm64-mac.zip')
  ...
  test('treats Windows checks as static inspection on non-Windows hosts', async () => {
    ...
    writeFile(rootDir, 'desktop/build-artifacts/electron/MiMo-Codex Setup 0.3.1.exe')
    writeFile(rootDir, 'desktop/build-artifacts/electron/MiMo-Codex Setup 0.3.1.exe.blockmap')
    ...
    writeFile(rootDir, 'desktop/build-artifacts/electron/latest.yml', 'path: MiMo-Codex Setup 0.3.1.exe\n')
  ...
  test('passes Windows directory-only checks for electron-builder --dir output', async () => {
    ...
    writeFile(rootDir, 'desktop/build-artifacts/electron/win-unpacked/MiMo-Codex.exe')
    writeFile(rootDir, 'desktop/build-artifacts/electron/win-unpacked/resources/app.asar')
    writeFile(rootDir, 'desktop/build-artifacts/electron/win-unpacked/resources/app.asar.unpacked/src-tauri/binaries/claude-sidecar-x86_64-pc-windows-msvc.exe')
    writeFile(rootDir, 'desktop/build-artifacts/electron/win-unpacked/resources/app.asar.unpacked/node_modules/node-pty/package.json')
    writeFile(rootDir, 'desktop/build-artifacts/electron/win-unpacked/resources/app.asar.unpacked/node_modules/node-pty/prebuilds/win32-x64/pty.node')
