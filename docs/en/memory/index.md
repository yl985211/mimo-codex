...
All illustrations use a dark background (#1a1a2e) + MiMo-Codex orange-blue accent (#FF7A00) style, consistent with the official Claude Code documentation.
...
- [MiMo-Codex Home](/en/)
- [Memory system source code](https://github.com/yl985211/mimo-codex/tree/main/src/memdir/)
- [Auto-extraction service](https://github.com/yl985211/mimo-codex/tree/main/src/services/extractMemories/)
- [AutoDream service](https://github.com/yl985211/mimo-codex/tree/main/src/services/autoDream/)
- [DreamTask](https://github.com/yl985211/mimo-codex/tree/main/src/tasks/DreamTask/)
- [GitHub Issues](https://github.com/yl985211/mimo-codex/issues)
