...
```bash
mimo-codex --no-computer-use
CLAUDE_COMPUTER_USE_ENABLED=0 mimo-codex
```

You can also write the global config file at `~/.claude/mimo-codex/computer-use-config.json`:
