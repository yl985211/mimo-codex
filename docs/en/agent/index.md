...
All diagrams use a dark background (#1a1a2e) with MiMo-Codex orange-blue accent (#FF7A00), consistent with Claude Code's official documentation style.
...
- [Agent Tool Source Code](https://github.com/yl985211/mimo-codex/tree/main/src/tools/AgentTool/)
- [Swarm Infrastructure](https://github.com/yl985211/mimo-codex/tree/main/src/utils/swarm/)
- [Task Management System](https://github.com/yl985211/mimo-codex/tree/main/src/tasks/)
