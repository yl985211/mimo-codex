...
Persist H5 settings in the existing mimo-codex managed settings path (`~/.claude/mimo-codex/settings.json`), preserving unknown fields and keeping the user-owned `~/.claude/settings.json` untouched:
